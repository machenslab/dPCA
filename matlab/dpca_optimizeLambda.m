...
%
% 'numComps'        - how many components to use in each marginalization 
%                     (default: 10)
%
...
for rep = 1:options.numRep
    ...
    for l = 1:length(options.lambdas)
        ...
        [W,V,whichMarg] = dpca(Xtrain, repmat(options.numComps, [1 length(XtestMargs)]), ...
